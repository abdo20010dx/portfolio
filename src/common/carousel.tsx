...
export default function Carousel({ posts }: Post) {
    ...
    return (
        <Box sx={{ flexGrow: 1, overflow: 'hidden', display: { xs: 'grid', md: 'grid', lg: "grid" } }}
        >
            {/* <Paper
                square
                elevation={0}
            ...
            <Grid container spacing={{ xs: 1, sm: 1, md: 1, lg: 1 }} columns={{ xs: 12, sm: 12, md: 12, lg: 12 }}>
                ...
                <DataGrid xs="none" sm="none" md={12} post={steps[activeStep]} key={steps[activeStep].id} lg={12} height="500rem" />
